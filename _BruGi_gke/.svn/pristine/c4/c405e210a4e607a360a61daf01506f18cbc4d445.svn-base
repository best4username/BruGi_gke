...
const t_configDef PROGMEM configListPGM[] = {
  ...
  {"gyrOffsetX",       INT16, &config.gyrOffset[0],       &initSensorOrientation},
  {"gyrOffsetY",       INT16, &config.gyrOffset[1],       &initSensorOrientation},
  {"gyrOffsetZ",       INT16, &config.gyrOffset[2],       &initSensorOrientation},
  
  {"accOffsetX",       INT16, &config.accOffset[0],       &initSensorOrientation},
  {"accOffsetY",       INT16, &config.accOffset[1],       &initSensorOrientation},
  {"accOffsetZ",       INT16, &config.accOffset[2],       &initSensorOrientation},
#if defined(GKE)
  {"gyrMX",       FLOAT, &config.gyrM[0],       &initSensorOrientation},
  {"gyrMY",       FLOAT, &config.gyrM[1],       &initSensorOrientation},
  {"gyrMZ",       FLOAT, &config.gyrM[2],       &initSensorOrientation},
  {"gyrTRef",     FLOAT, &config.gyrTRef,       &initSensorOrientation},
#endif
...
{
#if defined(GKE)
  printMessage(MSG_WARNING, F("GYRO Calibration, do not move, warm slowly ..."));
#else
